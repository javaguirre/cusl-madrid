<div class="buttons">
  <a href="<?php echo url_for('home/index') ?>" class="portada" title="Portada"><div>Portada</div></a>
   <!--<a href="#" class="prensa" title="Prensa"><div>Prensa</div></a>-->
  <a href="<?php echo url_for('project/index') ?>" class="proyectos" title="Proyectos"><div>Proyectos</div></a>
   <a href="<?php echo url_for('home/planet') ?>" class="planet" title="Planet"><div>Planet</div></a>
...
<!--   <a href="#premios-locales" class="local" title="Premios locales"><div>Premios locales</div></a> -->
<!--   <a href="#" class="microblog" title="Microblog"><div>Microblog</div></a> -->
<!--   <a href="#" class="media" title="Media"><div>Media</div></a> -->
