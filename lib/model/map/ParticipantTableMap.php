...
class ParticipantTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.ParticipantTableMap';
	...
	{
    $this->addRelation('Project', 'Project', RelationMap::MANY_TO_ONE, array('project_id' => 'id', ), 'CASCADE', 'RESTRICT');
	} // buildRelations()
